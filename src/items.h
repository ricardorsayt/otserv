...
enum ItemParseAttributes_t {
	...
	ITEM_PARSE_SPEED,
	ITEM_PARSE_WALKSPEED,
	ITEM_PARSE_HEALTHGAIN,
	ITEM_PARSE_HEALTHTICKS,
	ITEM_PARSE_FOLLOWVOCATIONTICKS,
	ITEM_PARSE_MANAGAIN,
	...
	ITEM_PARSE_HASHEIGHT,
	ITEM_PARSE_ALWAYSONTOP,
	ITEM_PARSE_ALWAYSONTOPORDER,
	ITEM_PARSE_ALLOWDISTREAD,
	ITEM_PARSE_LIGHTCOLOR,
	ITEM_PARSE_LIGHTLEVEL,
	ITEM_PARSE_ISHANGABLE,
	ITEM_PARSE_ISVERTICAL,
	ITEM_PARSE_ISHORIZONTAL,
	ITEM_PARSE_USEABLE,
	ITEM_PARSE_STACKABLE,
	ITEM_PARSE_ROTATABLE,
	ITEM_PARSE_FORCEUSE,
	ITEM_PARSE_POISONDAMAGECYLCES,
	ITEM_PARSE_REPLACEMAGICFIELDS,
	ITEM_PARSE_ISCROSSBOW,
	ITEM_PARSE_ISBOW,
	ITEM_PARSE_SPECIALFIELDBLOCKPATH,
	ITEM_PARSE_STOREITEM,
	ITEM_PARSE_RARITYTIER
};
...
struct Abilities {
	...
	bool followVocationTicks = false;
};
...
class Items
{
	public:
		...
		bool loadFromXml();
		void parseItemNode(pugi::xml_node& itemNode, uint16_t id);
