...
const char* getReturnMessage(ReturnValue value)
{
	switch (value) {
		...
		case RETURNVALUE_YOURVOCATIONCANNOTUSETHISITEM:
			return "You have the wrong vocation to use this item.";
		...
		case RETURNVALUE_CANONLYUSEONESHIELDWITHATTRIBUTE1:
			return "You have a shield with rarity equiped. You can not equip another shield.";
		case RETURNVALUE_CANONLYUSEONESHIELDWITHATTRIBUTE2:
			return "You cannot equip a shield with rarity while another shield is already equiped.";
		case RETURNVALUE_CANONLYUSEONESHIELDWITHATTRIBUTE3: // Possui
			return "You cannot use two shields with rarity.";
		...
		case RETURNVALUE_QUIVERARROWAMMOONLY:
			return "You can only move arrow ammo in here.";

		case RETURNVALUE_QUIVERBOLTAMMOONLY:
			return "You can only move bolt ammo in here.";
		...
		case RETURNVALUE_CANNOTUSEITEMINSTOREITEM:
			return "You cannot use this item inside of your Store inbox.";

		case RETURNVALUE_CANNOTMOVEITEMINSIDEGOLDPOUCH:
			return "You cannot move this item into your Gold Pouch unless it is gold.";

		case RETURNVALUE_CANNOTMOVEITEMINSIDESMALLSTONEPOUCH:
			return "You can only move small stone in here.";
...
std::string getMonsterClassName(uint16_t monsterClass)
{
	...
	case MONSTER_BOSS:
		return "boss";
	case MONSTER_MUTATED:
		return "mutate";
	case MONSTER_DJINN:
		return "djinn";
	case MONSTER_BONELORD:
		return "bonelord";
	...
	case MONSTER_DWARF:
		return "dwarf";
	case MONSTER_GEO_ELEMENTAL:
		return "geo-elemental";
	case MONSTER_PYRO_ELEMENTAL:
		return "pyro-elemental";
	case MONSTER_CRYO_ELEMENTAL:
		return "cryo-elemental";
	case MONSTER_ELECTRO_ELEMENTAL:
		return "electro-elemental";
	case MONSTER_DEMON:
		return "demon";
	case MONSTER_ARACHNID:
		return "arachnid";
	case MONSTER_WIZARD:
		return "wizard";
	default:
