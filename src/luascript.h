...
class LuaScriptInterface
{
	public:
		...
		static const luaL_Reg luaLoggerTable[3];
	...
	private:
		...
		static int luaLoggerGameLog(lua_State* L);
		static int luaLoggerNpcLog(lua_State* L);
		...
		static int luaGamePayHouses(lua_State* L);
		...
		static int luaPositionGetDistanceX(lua_State* L);
		static int luaPositionGetDistanceY(lua_State* L);
		...
		static int luaItemgetItemRarity(lua_State* L);
		static int luaItemgetItemTierRarity(lua_State* L);
		...
		static int luaItemapplyRarity(lua_State* L);
		static int luaItemRollRarity(lua_State* L);
		...
		static int luaPlayerRemoveKillingEnd(lua_State* L);

		static int luaPlayerGetItemCount(lua_State* L);
		static int luaPlayerGetItemById(lua_State* L);
		static int luaPlayerGetPouches(lua_State* L);
		...
		static int luaPlayerGetBestiaryStage(lua_State* L);

		static int luaPlayerSendCancelTarget(lua_State* L);

		static int luaPlayerUpdateBattlepass(lua_State* L);

		static int luaPlayerGetCharm(lua_State* L);
		static int luaPlayerGetCharmMonster(lua_State* L);
		static int luaPlayerSetCharm(lua_State* L);

		static int luaPlayerGetWound(lua_State* L);
		static int luaPlayerGetEnflame(lua_State* L);
		static int luaPlayerGetPoison(lua_State* L);
		static int luaPlayerGetZap(lua_State* L);
		static int luaPlayerGetCriticalChance(lua_State* L);
		static int luaPlayerGetDodge(lua_State* L);
		static int luaPlayerGetParry(lua_State* L);
		static int luaPlayerGetNumb(lua_State* L);
		static int luaPlayerGetAdrenalineBurst(lua_State* L);

		// Monster
		static int luaMonsterCreate(lua_State* L);

		static int luaMonsterGetList(lua_State* L);
		...
		static int luaMonsterAddAccountBound(lua_State* L);
		...
		static int luaNpcDialog(lua_State* L);
		...
		static int getRarityAttributeRequiredLevel(lua_State* L);
		...
		static int luaItemTypeGetSpellRune(lua_State* L);
		...
		static int luaMonsterTypeHaveBestiary(lua_State* L);
		static int luaMonsterTypeBestiaryRaceId(lua_State* L);
		static int luaMonsterTypeBestiaryClass(lua_State* L);
		static int luaMonsterTypeBestiaryProwess(lua_State* L);
		static int luaMonsterTypeBestiaryExpertise(lua_State* L);
		static int luaMonsterTypeBestiaryMastery(lua_State* L);
		static int luaMonsterTypeBestiaryDifficulty(lua_State* L);
		...
		static int luaSpellCategory(lua_State* L);
