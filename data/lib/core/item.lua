...
function Item.isStoreItem(self)
	return self:getCustomAttribute(ITEM_CUSTOM_ATTRIBUTE_STORE)
end
...
function Item.setStoreItem(self, value)
    value = value and value or false
     if value then
            self:setCustomAttribute(ITEM_CUSTOM_ATTRIBUTE_STORE, true)
     else
        self:removeCustomAttribute(ITEM_CUSTOM_ATTRIBUTE_STORE)
     end
