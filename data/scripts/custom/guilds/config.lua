GUILDS_CFG = {
  EXTOPCODE = 1, -- extended opcode id
  OPCODE = 51, -- normal opcode id (used in sending all wars kills), also check modules/gamelib/protocol.lua in client
  --
  ...
  --
  GOLD_FOR_LEVEL_VALUE = 3, -- used to calculate required gold for next guild level
  --
