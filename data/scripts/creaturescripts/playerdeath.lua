...
function creatureevent.onDeath(player, corpse, killer, mostDamageKiller, lastHitUnjustified, mostDamageUnjustified)
	...
	-- reset blessings for NPCs
	player:setStorageValue(101, -1)
	player:setStorageValue(102, -1)
	player:setStorageValue(103, -1)
	player:setStorageValue(104, -1)
	player:setStorageValue(105, -1)
	...
	if killer then
		...
		if byPlayer then
			...
			killerName = killer:getDescription()
		end
	else
	...
	if mostDamageKiller then
		...
		if byPlayerMostDamage then
			mostDamageName = mostDamageKiller:getName()
		else
			mostDamageName = mostDamageKiller:getDescription()
		end
	else
