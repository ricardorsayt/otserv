...
-- Promotion handling
	...
	nextUseStaminaTime[playerGuid] = 1
	nextUseXpStamina[playerGuid] = 1
...
function logoutMessage.onLogout(player)
	...
	if nextUseStaminaTime and nextUseStaminaTime[player:getGuid()] then
