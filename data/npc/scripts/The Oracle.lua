...
local config = {
	...
	vocations = {
		["sorcerer"] = {
			...
			{
				[CONST_SLOT_RIGHT] = {2175, 1},
				[CONST_SLOT_LEFT] = {2190, 1},
				[CONST_SLOT_ARMOR] = {8819, 1},
				[CONST_SLOT_HEAD] = {8820, 1},
				[CONST_SLOT_LEGS] = {2468, 1},
				
				[CONST_SLOT_NECKLACE] = {2661, 1}
			},
		...
		["paladin"] = {
			...
			vocationId = 3,
			{
				[CONST_SLOT_RIGHT] = {2525, 1},
				[CONST_SLOT_LEFT] = {2389, 5},
				[CONST_SLOT_ARMOR] = {2660, 1},
				[CONST_SLOT_HEAD] = {2480, 1},
				[CONST_SLOT_LEGS] = {8923, 1},
			...
			{{2120, 1}, {2554, 1}, {40965, 1}, {7618, 1}, {2456, 1}, {2544, 50}, {18559, 1}}
		},
		...
		["knight"] = {
			...
			{
				[CONST_SLOT_RIGHT] = {2525, 1},
				[CONST_SLOT_LEFT] = {8601, 1},
				[CONST_SLOT_ARMOR] = {2465, 1},
				[CONST_SLOT_HEAD] = {2460, 1},
				[CONST_SLOT_LEGS] = {2478, 1},
...
local function creatureSayCallback(cid, type, msg)
	...
	if npcHandler.topic[cid] == 0 then
		if msgcontains(msg, "yes") then
			npcHandler:say("IN WHICH TOWN DO YOU WANT TO LIVE: {VENORE}, {THAIS}, {KAZORDOON}, {CARLIN}, {AB'DENDRIEL}, {LIBERTY BAY}, {PORT HOPE}, {ANKRAHMUN}, {DARASHIA}, {EDRON}, OR {SVARGROND}?", cid)
	...
	elseif npcHandler.topic[cid] == 1 then
		...
		if cityTable then
			...
			npcHandler:say("IN WHICH TOWN DO YOU WANT TO LIVE: {THAIS}, {EDRON}, OR {ANKRAHMUN}?", cid)
		end
	...
	elseif npcHandler.topic[cid] == 3 then
		if msgcontains(msg, "yes") then
			...
			for slot, it in pairs(targetVocation[1]) do
				local playerItem = player:getSlotItem(slot)
				if playerItem then
					playerItem:transform(it[1], it[2])
				else
					player:addItem(it[1], it[2])
				end
			end
